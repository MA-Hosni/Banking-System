...
Built with Next.js, Cashini is a modern banking platform for everyone. Cashini is a financial SaaS platform that connects to multiple bank accounts, displays transactions in real-time, allows users to transfer money to other platform users, and manages their finances altogether
...
```bash
git clone https://github.com/MA-Hosni/Banking-System
cd Banking-System
```
